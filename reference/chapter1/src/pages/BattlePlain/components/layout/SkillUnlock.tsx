...
export const SkillUnlock: React.FC<SkillUnlockProps> = ({ onUnlock }) => {
  ...
  return (
    <div className="skill-unlock-overlay" style={{ backgroundImage: `url(${bgImage})` }}>
      {/* 遮罩层 */}
          ...
          <div className="npc-phase">
            <div className="npc-dialogue">
              <div className="npc-portrait-container">
                 <img src={timelordImg} alt="Time Guardian" className="npc-portrait" />
              </div>
              <div className="npc-name-tag">{SCRIPT.ch2_npc_name}</div>
            ...
            <div className="skill-info">
              ...
              <div className="skill-effect">
                ...
                <div className="effect-text">
                  ...
                  <span className="effect-value">使Boss <strong>2回合</strong> 无法行动</span>
                </div>
              </div>
            </div>
