...
const WorldMap: React.FC = () => {
  ...
  useEffect(() => {
    const cleanup = scheduleIdle(() => setIsHeavyBackgroundEnabled(true), 1200);
    return cleanup;
  }, []);
  ...
  return (
    <div className="world-map-container">
      {/* Map Nodes */}
      <div className={`map-viewport animate-fade-in-up delay-200 ${isHeavyBackgroundEnabled ? 'heavy-bg' : ''}`} ref={containerRef}>
        <SpriteCharacter 
            image={spriteSheet}
            x={playerPos.x}
            y={playerPos.y}
