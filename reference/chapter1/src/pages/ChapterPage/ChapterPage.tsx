...
const ChapterPage: React.FC = () => {
  ...
  const { completeChapter, completeQuest, updateChapterProgress, state, getQuestStatus } = usePlayer();
        ...
        <div className="content-scroll">
          ...
          <div id="section-outro" className="story-section">
            ...
            <div className="chapter-actions">
              <Button onClick={handleComplete} disabled={isChapterCompleted} className={isChapterCompleted ? '' : 'animate-pulse'}>
                {isChapterCompleted ? '已完成' : '完成章节'}
              </Button>
            </div>
          </div>
