...
export const INTRO_DIALOGUES: Dialogue[] = [
  ...
  },
  {
    id: 'nv06_4',
    speaker: '黑话村长',
    text: '听好了。我先给你一张地图，离开新手村后，你将进入“黑话起源之森”——那里藏着传说中的「术语词典」。',
  },
  {
    id: 'nv06_5',
    speaker: '黑话村长',
    text: '拿到词典只是开始。你还要去「战斗本体平原」、「玩家生态城镇」、「经济与氪金之都」和「弹幕大峡谷」闯荡。每征服一片区域，你都能获得一个「特别技能」。',
  },
  {
    id: 'nv06_6',
    speaker: '黑话村长',
    text: '收集齐这些力量，你才能前往「魔王城」，击败那个盘踞在数据深处的最终BOSS！这就是你此行的终极使命。',
  },
  {
    id: 'nv06_7',
    speaker: '黑话村长',
    text: '现在，去村口吧。雾后面，就是你的第一张大地图。',
    action: 'unlock_gate'
  }
];
...
export const MENU_TUTORIAL_DIALOGUE: Dialogue[] = [
  ...
  },
  {
    id: 'menu_2',
    speaker: '黑话村长',
    text: '📜 任务列表：告诉你本章要做什么；🏅 成就：记录你翻车和高光的瞬间；📖 术语图鉴：通关第一章后解锁，当你看到不懂的词，就能来查。',
