  ...
  return (
    <div className="title-page">
        ...
        <Panel className="menu-panel animate-fade-in-up delay-200">
          <div className="menu-buttons">
            ...
            <div
              ...
              onMouseLeave={() => setHoveredMenu(null)}
            >
              <Button onClick={() => navigate('/dictionary')} variant="secondary" disabled={!state.dictionaryUnlocked}>
                {!state.dictionaryUnlocked ? (
                  <>
                    <Icon name="lock" size="sm" /> DICTIONARY
                  </>
                ) : (
                  <>DICTIONARY</>
                )}
      ...
      <div 
        ...
        style={{ cursor: state.dictionaryUnlocked ? 'pointer' : 'not-allowed', opacity: state.dictionaryUnlocked ? 1 : 0.6 }}
      >
